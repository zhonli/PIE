(function () {
    ...
    var filter = function () {
        if (selectedSprintId) {
            return "$expand=TestCollateral,TaskLink&$filter=SprintID ge {SprintID} and (Status ne PIEM.Common.Model.PlanStatus'Obsoleted')".replace('{SprintID}', selectedSprintId);
        }
        return "$expand=TestCollateral,TaskLink&$filter=(SprintID ge {SprintID} or SprintID eq null) and (Status ne PIEM.Common.Model.PlanStatus'Obsoleted')".replace('{SprintID}', curSprintId);
    };
    ...
    var source =
    {
        ...
        //sort: function (cloumn, direction) {
        //    console.log(">>sort: cloumn, direction");
        //    console.log(cloumn);
    ...
    var aptPlans = new $.jqx.dataAdapter(source, {
        ...
        loadServerData: function (serverdata, source, callback) {
            ...
            console.log('>>dataAdapter.loadServerData: serverdata, source, callback');
        ...
        */
        beforeSend: function (jqXHR, settings) {
            ...
            console.log('>>dataAdapter.beforeSend: jqXHR, settings');
    ...
    $("#jqxgrid").on("sort", function (event) {
        ...
        //    sortdirection = "null";
        //}
        console.log(">>jqxgrid.sort :: sortinformation");
